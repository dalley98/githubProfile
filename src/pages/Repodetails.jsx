...
function Repodetails(){
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/dalley98/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/dalley98/${id}/branches`)
    .then((response) => (response.json()))
    .then((data) => {
      setBranch(data)
    })
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/dalley98/${id}/deployments`)
    .then((response) => (response.json()))
    .then((data) => {
      setDeployment(data)
    })
    ...
    <div id="repodetail">
        <div className="repodetail-card">
            ...
            <div className="repo-mini-details">
              {/* <p><BsActivity className='icons'/> Avtivity: {details.activity}</p> */}
            ...
            <p>Live site: {deployment.length === 0 ? `none` : <a href={`https://dalley98.github.io/${details.name}`}>dalley98.github.io/{details.name}</a>}</p>
